import { faSquarePlus, faCreditCard, faWallet, faPiggyBank, faMoneyCheck, faHandHoldingDollar, faCashRegister, faUser } from '@fortawesome/free-solid-svg-icons';
                        ...
                        (account) =>
                            <tr key={account.id}>
                                <td>{
                                    account?.icon ?
                                        <Image
                                            src={account.icon} alt={`${account.name} icon`}
                                            width={32}
                                            height={32}
